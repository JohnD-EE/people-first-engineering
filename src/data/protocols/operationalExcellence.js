const protocol = {
    ...
    sections: [
        ...
        },
        {
            ...
            paragraphs: [
                'Bottlenecks and Waste in the SDLC SHOULD be identified and addressed in cycles of Continuous Improvement cycles.',
        ...
        },
        {
            ...
            paragraphs: [
                ...
                'It SHOULD be easy to focus on building and deploying code without unnecessary worries over infrastructure and tools.',
        ...
        },
        {
            ...
            paragraphs: [
                ...
                'Coaching and mentoring to improve Engineer Soft SKills SHOULD be provided on a regular cadence.'
            ],
        },
    ],
    conclusions: [],
